  ...
  <body>
    <div class="container">
      ...
      <form id="cotizacion-form" action="cotizacion.php" method="POST">
        ...
        <div class="form-group">
          <label for="servicio" class="required"
            ><i class="fas fa-list"></i> Tipo de servicio solicitado:</label
          >
        ...
        <div class="form-group">
          <label for="fecha" class="required"
            ><i class="fas fa-calendar"></i> Fecha deseada:</label
          >
          <input type="date" id="fecha" name="fecha" required />
        </div>
        <div class="form-group">
          <label for="personas" class="required"
            ><i class="fas fa-users"></i> Número de personas:</label
          >
          <input type="number" id="personas" name="personas" required />
        </div>
        <div class="form-group">
          <label for="comentarios"
            ><i class="fas fa-comment"></i> Comentarios adicionales o requisitos
            especiales:</label
          >
